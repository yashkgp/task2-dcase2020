...
def plotter(x, isanom):
    ...
    plt.savefig('../'+isanom+'rfft_spect_r.png')
    ...
    plt.savefig('../'+isanom+'wav_spect_6.png')
    ...
    plt.savefig('../'+isanom+'wav_spect_10.png')
    ...
    plt.savefig('../'+isanom+'rfft_mod_b.png')
    ...
    plt.savefig('../'+isanom+'wav_mod_6.png')
    

if __name__ == "__main__":

    normal, sr =  librosa.load('../task2-dcase2020/data/pump/train/normal_id_00_00000000.wav')
    anom, sr = librosa.load('../task2-dcase2020/data/pump/test/anomaly_id_02_00000000.wav')
    plotter(normal, 'normal')
    plotter(anom, 'anom')
